...
export function FlashcardReview() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">📚 Flashcard Review</h1>
      ...
      <Card className="p-6 mb-6">
          ...
          <div className="text-center">
            ...
            {showAnswer && (
              <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                <div className="text-gray-700">{currentCard.answer}</div>
        ...
        <div className="flex justify-center mt-6">
          {!showAnswer ? (
            <Button onClick={() => setShowAnswer(true)} variant="primary">
              Show Answer
            </Button>
          ) : (
